...
function formButtonPressed(f,whichButton)
{
    if(whichButton=="run") {
        ...
        if ($(codecid).prop('checked') || $(cpuinfo).prop('checked') || $(biosSystem).prop('checked') || $(biosVideo).prop('checked') || $(diskLoaderConfigs).prop('checked') || $(bootLoaderBootSectors).prop('checked') || $(diskPartitionInfo).prop('checked') || $(firmmemmap).prop('checked') || $(kexts).prop('checked') || $(lspci).prop('checked') || $(memory).prop('checked')) {
